...
| No. | Name and Link |
|-----:|---------------|
|     1|  ![image](https://github.com/user-attachments/assets/cd392787-2c5b-48a2-ac8b-0fe35227f59d)  
[*GOOGLE FONTS*](https://fonts.google.com) - A huge repository for free to use fonts which powered every single character in out website. |
